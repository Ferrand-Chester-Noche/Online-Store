    ...
    <tbody>
        ...
        <tr>
            <td scope = "col" class="col-images">
                <img class="images"src="{{asset('uploads/'.$sale->image)}}" alt="Image">
            </td>
            <td scope = "col">{{$sale->saleid}}</td>
            <td scope = "col">{{$sale->pname}}</td>
            <td scope = "col">{{$sale->prodid}}</td>
            <td scope = "col">{{$sale->name}}</td>
            <td scope = "col">{{$sale->quantity}}</td>
            <td scope = "col">{{$sale->cost}}</td>
            <td scope = "col">{{($sale->quantity)*($sale->cost)}}</td>
        </tr>
        @endforeach
    </tbody>
    </table>
