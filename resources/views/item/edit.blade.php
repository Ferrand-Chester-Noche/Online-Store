            ...
            <div class="card-body">
                ...
                <table class = "table table-borderless">         
                    <tr>
                        ...
                        <td scope = "row" ><i>{{$product->name}}</i></td>
                    </tr>
                    <tr>
                        <th scope = "row">Cost: </td>
                        <td scope = "row"><i>{{$product->cost}}</i></td>
                    </tr>
                    <tr>
                        <th scope = "row">Qty: </td>
                        <td scope = "row"><i>{{$product->quantity}}</i></td>
                    </tr>
                </table>
                </div>
                </div>
                ...
                <form action="{{ url('/account/update/'.$product->prodid) }}" method="post">
                    @csrf
