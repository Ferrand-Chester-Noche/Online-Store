...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                        <h5 class="brand-name" id="logo">{{$data->name}}</h5>
    ...
    <thead>
        ...
        <th scope = "col" class="remove">Remove From Cart</th>
    </thead>
    <tbody>
        @foreach($carts as $cart)
        <tr>
            <td scope = "col" class="col-images">
                <img class="images"src="{{asset('uploads/'.$cart->image)}}" alt="Image">
            </td>
            <td scope = "col">{{$cart->prodid}}</td>
            <td scope = "col">{{$cart->pname}}</td>
            <td scope = "col">{{$cart->cost}}</td>
            <td scope = "col">{{$cart->quantity}}</td>
            <td scope = "col">{{($cart->quantity)*($cart->cost)}}</td>
            <td scope = "col"><a href="{{url('remove/'.$cart->cartid)}}" class = "btn">Remove</a></td>
        </tr>
        @endforeach
    </tbody>
    </table>
    ...
    <div class="btn-div">
        <a href="{{url('/account/cart/buy')}}" class = "btn">Buy Items</a> 
    </div>
