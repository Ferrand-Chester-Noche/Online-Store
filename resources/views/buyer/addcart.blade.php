...
<body>
        ...
        <div class="top-navbar">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <a  class="logo" href="{{url('account/buyer')}}"><h5 class="brand-name">{{$data->name}}</h5></a>
                    </div>
                    ...
                    <div class="col-md-5 my-auto">
                        <ul class="nav justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li><a class="dropdown-item" href="{{url('account/cart')}}"><i class="fa fa-shopping-cart"></i> My Cart</a></li>    
    ...
    <section class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form  action="{{ url('/account/addtocart/'.$product->prodid) }}" method="post" enctype = "multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>Product ID</label>
                        <input type="text" name="prodid" disabled="disabled" value="{{$product -> prodid}}" class="form-control">
                        @error('prodid')<p class="text text-danger">{{ $message }}</p> @enderror
                    </div>
                    <div class="form-group" >
                        <label>Product Name</label>
                        <input type="text" name="name" disabled="disabled" value="{{$product -> name}}" class="form-control">
                        @error('name')<p class="text text-danger">{{ $message }}</p> @enderror
                    </div>
                    <div class="form-group">
                        <label>Cost</label>
                        <input type="text" name="cost" disabled="disabled" value="{{$product -> cost}}" class="form-control">
                        @error('cost')<p class="text text-danger">{{ $message }}</p> @enderror
                    </div>
                    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-1 my-auto">
                <a href="{{url('account/buyer')}}"><div class="character">
