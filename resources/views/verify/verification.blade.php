        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="d-inline" method="GET" action="{{ URL('mail') }}">
                        @csrf
                        <button type="submit" class="btn btn-link p-0 m-0 align-baseline">{{ __('click here to request another') }}</button>.
                    </form>
                    <form class="d-inline" method="POST" action="{{ route('verifyCode') }}">
                        @csrf
                        <div class="form-group">
                        <label>Verificarion Code</label>
                        <input type="text" name="code" value = "{{old('code')}}" class="form-control">
                        @error('code')<p class="text text-danger">{{ $message }}</p> @enderror
                        </div>   
                        <div class="btn-div">
                        <button type="submit" class="btn" onclick="window.location.href='{{  route('verifyCode')  }}'">Enter</button>
                        </div>                 
                    </form>
