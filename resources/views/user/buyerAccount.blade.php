...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-5 my-auto">
                        <form action = "/buyer/search" method = "POST" role="search">
                                {{csrf_field()}}
    ...
    <thead>
        ...
        <th scope = "col">Qty.</th>
        <th scope = "col" class="addto">Add To Cart</th>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td scope = "col"><a href="{{url('account/addcart/'.$product->prodid)}}" class = "btn">Add </a></td>
        </tr>
        @endforeach
    </tbody>
    </table>
