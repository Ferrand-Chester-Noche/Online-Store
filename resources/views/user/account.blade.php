...
<body>
                    ...
                    <div class="col-md-10 my-auto">
                        <ul class="nav justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li><a class="dropdown-item" href="{{url('account')}}"><i class="fa fa-user"></i> Profile</a></li>
                                <li><a class="dropdown-item" href="#"><i class="fa fa-shopping-cart"></i> My Cart</a></li>
                                <li><a class="dropdown-item" href="{{url('account')}}"><i class="fa fa-shopping-bag"></i> Shop</a></li>
    ...
    </svg> 2023 All Rights Reserved | nabi feet pics
    </div>
