...
<body>
        ...
        <div class="top-navbar">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <a class="logo" href="{{url('account/seller')}}"><h5 class="brand-name">{{$data->name}}</h5></a>
                    ...
                    <div class="col-md-10 my-auto">
                        <ul class="nav justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li><a class="dropdown-item" href="{{url('account/seller')}}"><i class="fa fa-user"></i> Profile</a></li>
                                <li><a class="dropdown-item" href="{{url('account/myShop')}}"><i class="fa fa-shopping-bag"></i>Check My Shop</a></li>
    ...
    <div class="txt">
    <h3 class = "text-cls">Seller Account Page</h3>
    <h5 class = "p-cls">Your Products:</h5>
    </div>
    <div class = "tbl">
    ...
    <tbody>
        ...
        <tr>
            <td scope = "col" class="col-images">
                <!--{{$product->image}}-->
                <img class="images"src="{{asset('uploads/'.$product->image)}}" alt="Image">
            </td>
            <td scope = "col">{{$product->prodid}}</td>
            <td scope = "col">{{$product->name}}</td>
            <td scope = "col">{{$product->cost}}</td>
            <td scope = "col">{{$product->quantity}}</td>
            <td scope = "col"><a href="{{url('/account/edit/'.$product->prodid)}}" class = "btn">Edit</a></td>
            <td scope = "col"><a href="{{url('delete/'.$product->prodid)}}" class = "btn">Delete</a></td>
        </tr>
        @endforeach
    </tbody>
    </table>
    ...
    <div class="fixed-bottom" id="footer">
        <div class="row">
            ...
            <div class="col-md-1 my-auto">
                <a href="{{url('account/seller')}}"><div class="character">
